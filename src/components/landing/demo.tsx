...
export default function Demo({
	...
	return (
		<div className="py-14 sm:px-0 px-4">
			<div className="bg-secondary rounded-lg p-2 max-w-3xl mx-auto">
				<div className="flex flex-row justify-start items-center gap-2 p-2">
					<span className="relative flex h-4 w-4">
						<span className="absolute inline-flex h-full w-full rounded-full bg-border opacity-75" />
					</span>
					<span className="relative flex h-4 w-4">
						<span className="absolute inline-flex h-full w-full rounded-full bg-border opacity-75" />
					</span>
				...
				>
					<div className="relative w-full aspect-video bg-black rounded-lg overflow-hidden">
						...
						<span id="video-description" className="sr-only">
							Demonstration video showing how Echo works.
						</span>
						...
						<div className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-60">
							...
							<p className="text-gray-300 text-sm">See how Echo works</p>
						</div>
						...
						<div
							...
							style={{
								boxShadow:
									"inset 0 0 50px rgba(0, 0, 0, 0.8), inset 0 0 20px rgba(107, 92, 231, 0.3), inset 0 0 20px rgba(107, 92, 231, 0.3), inset 0 0 20px rgba(107, 92, 231, 0.3)",
							}}
						/>
					</div>
				</div>
