					...
					<AnimatePresence mode="wait">
						{step === 1 ? (
							...
							>
								...
								<button
									type="submit"
									className="absolute right-0 top-0 bottom-0 bg-accent text-accent-foreground px-5 py-2 m-2 rounded-[12px] font-semibold hover:opacity-90 disabled:opacity-50"
									disabled={loading}
								>
									{t("form.continue")}
								</button>
